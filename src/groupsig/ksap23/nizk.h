 ...
 */
 ...
 #ifndef _KSAP23_NIZK_H
 #define _KSAP23_NIZK_H
 
 #include "types.h"
 #include "sysenv.h"
 #include "shim/pbc_ext.h"
 #include "crypto/spk.h" // s tymto treba daco asi robit, lebo to je ten hlavny subor s ostatnymi spk a pre ksap23 by to teoreticky mohlo byt vsetko tunak
 
 #ifdef __cplusplus
 extern "C" {
 #endif
   
   typedef struct _ksap23_nizk0_t {
   ...
   typedef struct _ksap23_nizk1_t {
   ...
   /**
    * @fn int ksap23_nizk0_sign(spk_rep_t *pi,
    *                          void *y[], uint16_t ny,
    *	                      void *g[], uint16_t ng,
    *		              void *x[], uint16_t nx,
    ...
    */
   int ksap23_nizk0_sign(spk_rep_t *pi,
                void *y[], uint16_t ny,
                void *g[], uint16_t ng,
    ...
    * @return IOR or IERROR.
    */
   int ksap23_nizk0_verify(uint8_t *ok,
              void *y[], uint16_t ny,
              void *g[], uint16_t ng,
              uint16_t i[][2], uint16_t ni,
              uint16_t *prods,
   ...
   /**
    * @fn ksap23_nizk1_t* ksap23_nizk1_init();
    * Initializes a data structures for SPKs used in open proofs in KSAP23.
    *
    * NOTE: This function will be removed with issue23.
    *
    * @return A pointer to the allocated structure.
    */  
   ksap23_nizk1_t* ksap23_nizk1_init();
 
   /**
    * @fn int ksap23_nizk1_free(ksap23_nizk1_t *pi);
    ...
    */  
   int ksap23_nizk1_free(ksap23_nizk1_t *pi);
 
   /**
    * @fn int ksap23_nizk1_get_size(ksap23_nizk1_t *pi);
    ...
    */
   int ksap23_nizk1_get_size(ksap23_nizk1_t *pi);
 
   /**
    * @fn int ksap23_nizk1_export(byte_t **bytes, uint64_t *len, ksap23_nizk1_t *pi);
    ...
    * @return The number of bytes, or -1 if error.
    */  
   int ksap23_nizk1_export(byte_t **bytes, uint64_t *len, ksap23_nizk1_t *pi);
   
   /**
    * @fn ksap23_nizk1_t* ksap23_nizk1_import(byte_t *bytes, uint64_t *len);
    * Imports a KSAP23 SPK of opening from the given array of bytes.
    *
    * NOTE: This function will be removed with issue23.
    *
    ...
    */  
   ksap23_nizk1_t* ksap23_nizk1_import(byte_t *bytes, uint64_t *len);
 
   /**
    * @fn int ksap23_nizk1_sign(ksap23_nizk1_t *pi,
    ...
    *		              byte_t *msg,
    *		              uint32_t size);
    * Computes an SPK proving opening correctness in KSAP23.
    *
    * NOTE: This function will be removed with issue23.
    *
    * @param[in,out] pi An initialized SPK structure for KSAP23 openings. 
    ...
    * @return IOK or IERROR.
    */  
   int ksap23_nizk1_sign(ksap23_nizk1_t *pi,
                pbcext_element_G2_t *xx,
                pbcext_element_G1_t *g1,
                pbcext_element_G1_t *g2,
                pbcext_element_GT_t *e1,
   ...
   /**
    * @fn int ksap23_nizk1_verify(uint8_t *ok,
    *                            ksap23_nizk1_t *pi,
    *                            pbcext_element_G1_t *g1,
    *                            pbcext_element_G1_t *g2,
    *			        pbcext_element_GT_t *e1,
    ...
    *			        byte_t *msg,
    *			        uint32_t size);
    * Verifies an SPK proving opening correctness in KSAP23.
    *
    * NOTE: This function will be removed with issue23.
    *
